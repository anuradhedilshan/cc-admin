...
export class Null1759647726335 implements MigrationInterface {

   public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_customer_event_registration" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "regType" varchar CHECK( "regType" IN ('individual','club','organization','gym') ) NOT NULL DEFAULT ('individual'), "category" varchar NOT NULL DEFAULT ('general'), "title" varchar NOT NULL, "orgname" varchar, "eventdate" datetime NOT NULL, "code" varchar NOT NULL, "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "customerId" integer, CONSTRAINT "FK_8c81c47388698e7886131f49c93" FOREIGN KEY ("customerId") REFERENCES "customer" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
